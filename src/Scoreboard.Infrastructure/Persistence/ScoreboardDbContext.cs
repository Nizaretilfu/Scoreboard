...
public sealed class ScoreboardDbContext(DbContextOptions<ScoreboardDbContext> options) : DbContext(options), IScoreboardDbContext
{
    public DbSet<Competition> Competitions => Set<Competition>();
    public DbSet<Participant> Participants => Set<Participant>();
    public DbSet<Heat> Heats => Set<Heat>();
    public DbSet<Run> Runs => Set<Run>();
    public DbSet<RunParticipant> RunParticipants => Set<RunParticipant>();
