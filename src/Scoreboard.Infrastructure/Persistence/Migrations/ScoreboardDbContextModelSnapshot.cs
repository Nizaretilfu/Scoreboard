        ...
        modelBuilder.Entity("Scoreboard.Domain.Heats.Heat", b =>
            {
                ...
                b.HasIndex("CompetitionId", "SequenceNumber")
                    .IsUnique();
        ...
        modelBuilder.Entity("Scoreboard.Domain.Runs.Run", b =>
            {
                ...
                b.HasIndex("HeatId", "SequenceNumber")
                    .IsUnique();
        ...
        modelBuilder.Entity("Scoreboard.Domain.Scoring.ScoreEntry", b =>
            {
                ...
                b.HasIndex("RunId", "ParticipantId")
                    .IsUnique();

                b.ToTable("score_entries", (string)null);

                b.ToTable("score_entries", t =>
                    {
                        t.HasCheckConstraint("ck_score_entries_rings", "rings >= 0 AND rings <= 2");
                    });
            });
